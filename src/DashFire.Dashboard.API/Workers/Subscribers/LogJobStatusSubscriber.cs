...
namespace DashFire.Dashboard.API.Workers.Subscribers
{
    public class LogJobStatusSubscriber : IHostedService
    {
        ...
        private readonly ILogger<LogJobStatusSubscriber> _logger;
        ...
        public LogJobStatusSubscriber(IOptions<ApplicationOptions> options, ILogger<LogJobStatusSubscriber> logger, IServiceProvider serviceProvider, DashFireCacheManager cacheManager)
        {
